...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Russel.Jacobi',
      password: 'AC5g5U86m8flxa_',
      email: 'Graham_Gorczany67@yahoo.com',
      name: 'Wade Wuckert',
      mobileNo: '397-298-0099 x8805',
      userType: 516,
      resetPasswordLink: {},
      loginRetryLimit: 662,
      loginReactiveTime: '2022-10-01T05:29:14.307Z',
      id: '622842fa030b3b2812a2c788'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Walker85',
        'password':'kHNU4Lcr3yXWAIh',
        'email':'Delta.Zulauf@yahoo.com',
        'name':'Mrs. Sarah Roberts',
        'mobileNo':'1-947-461-9329 x160',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Delta.Zulauf@yahoo.com', });
